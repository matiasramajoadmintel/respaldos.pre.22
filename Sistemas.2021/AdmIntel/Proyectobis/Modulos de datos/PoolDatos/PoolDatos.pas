...
type
  ...
  private
    procedure GenerarDescuentosAlquilerMilitares(Mes, Anio: Word);
    procedure GenerarDescuentosAlquilerCiviles(Mes, Anio: Word);
...
begin
  ...
  GenerarDescuentosAlquilerMilitares(Mes, Anio);
  GenerarDescuentosAlquilerCiviles(Mes, Anio);

  OcultarMSJ;
end;

procedure TdmDatos.GenerarDescuentosAlquilerMilitares(Mes, Anio: Word);
var
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        {if (qryOcupCivilesIDOCUPANTE.Value = 445) then
        begin
          MsjInfo('Aca esta');
        end;}
...
procedure TdmDatos.GenerarDescuentosAlquilerCiviles(Mes, Anio: Word);
var
...
//Obtiene el número total de viviendas
  ...
  TotalViviendas := qryCantViviendasTOTAL_VIVIENDAS.Value - 42; //******* cambiar por acticado desactiado
...
//Obtiene los gastos de servicios para cada edificio.
  ...
  try
    ...
    begin
      ...
      begin
        {if (qryDeptosOcupadosIDPERSONA.Value = 410) then
        begin
          MsjInfo('Aca esta');
        end;}
