object frmElecTipoDesc: TfrmElecTipoDesc
  Left = 192
  Top = 107
  Width = 544
  Height = 375
  ...
  object Query1: TQuery
    ...
    object Query1IDTIPODESCUENTO: TIntegerField
      ...
      Origin = 'DB.TIPO_DESCUENTO.IDTIPODESCUENTO'
    end
    object Query1CODDESC: TIntegerField
      FieldName = 'CODDESC'
      Origin = 'DB.TIPO_DESCUENTO.CODDESC'
    end
    object Query1OPERACION: TStringField
      FieldName = 'OPERACION'
      Origin = 'DB.TIPO_DESCUENTO.OPERACION'
      Size = 5
    end
    object Query1TIPOPAGO: TStringField
      FieldName = 'TIPOPAGO'
      Origin = 'DB.TIPO_DESCUENTO.TIPOPAGO'
      Size = 2
    end
    object Query1DESCRIPCION: TStringField
      FieldName = 'DESCRIPCION'
      Origin = 'DB.TIPO_DESCUENTO.DESCRIPCION'
      Size = 15
    end
  end
end
