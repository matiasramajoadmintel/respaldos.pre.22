...
type
  TfrmQRExpDeptosVacios = class(TForm)
    report: TQuickRep;
    DetailBand1: TQRBand;
...
var
  frmQRExpDeptosVacios: TfrmQRExpDeptosVacios;
...
procedure TfrmQRExpDeptosVacios.VistaPrevia(const Mes, Anio: Word;
                                        const IdEdif: Integer; const Desc: String);
begin
...
procedure TfrmQRExpDeptosVacios.Imprimir(const Mes, Anio: Word;
                                     const IdEdif: Integer; const Desc: String);
begin
  AbrirQry(Mes,Anio,IdEdif,Desc);
  SumarImportes;
...
procedure TfrmQRExpDeptosVacios.qryTrabCalcFields(DataSet: TDataSet);
begin
...
procedure TfrmQRExpDeptosVacios.AbrirQry(const Mes, Anio: Word;
                                     const IdEdif: Integer; const Desc: String);
var
  D: String;
begin
...
procedure TfrmQRExpDeptosVacios.SumarImportes;
var
  TE, TC: Currency;
begin
  with qry do
...
procedure TfrmQRExpDeptosVacios.FormClose(Sender: TObject;
