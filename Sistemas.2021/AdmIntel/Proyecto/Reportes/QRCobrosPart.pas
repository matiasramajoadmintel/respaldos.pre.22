...
type
  TfrmQRCobrosPart = class(TForm)
    ...
    QRDBText9: TQRDBText;
    QRExpr5: TQRExpr;
    tblCobrosPartIDPERSONA: TIntegerField;
    tblCobrosPartOCUPANTE: TStringField;
    tblCobrosPartDOCUMENTO: TStringField;
    tblCobrosPartMES: TStringField;
    tblCobrosPartANIO: TIntegerField;
    ...
    tblCobrosPartEDIFICIO: TStringField;
    tblCobrosPartDEPTO: TStringField;
    tblCobrosPartLOCACION: TStringField;
...
begin
  ...
  // Crea una aplicacion Excel.
    ...
    Libro.Cells [i+6,5] := Format('%n', [qryCobrosPartExpFR.Value]);
