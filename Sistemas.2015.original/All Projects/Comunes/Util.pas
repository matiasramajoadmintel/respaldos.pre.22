...
Function Confirmar(const Mensaje: PChar): Boolean;
begin
  Result := (Application.MessageBox(Mensaje, 'Confirmar', mb_Yesno) = IDYes);
end;

Procedure MsjError(const Mensaje: PChar);
begin
  Application.MessageBox(Mensaje,'Error!',mb_ok);
end;

Procedure MsjInfo(const Mensaje: PChar);
begin
  Application.MessageBox(Mensaje,'Información',mb_ok);
end;

Function MsjOKCancel(const Mensaje: PChar): Boolean;
begin
  Result := (Application.MessageBox(Mensaje,'Información',mb_okCancel) = IDOK);
end;

Function MsjYesNoCancel(const Mensaje: PChar): Integer;
begin
  Result := (Application.MessageBox(Mensaje,'Confirmar',MB_YESNOCANCEL));
end;
