...
uses Messages,Windows, Graphics,SysUtils,Extctrls,StdCtrls,Controls,
     ...
     DbTables,DB,DBCtrls,DBGrids,ShellApi;
...
//Funcion que permite borrar los registro que de una tabla que cumplan
...
begin
     ...
     try
      GRD.Columns.LoadFromFile(ExtractFilePath(Application.ExeName)+ArchCol);
             ...
             begin MessageDLG('Error en archivo de inicializacion de columnas',
                   mtError,[mbOk],0);
             end;
     end;
end;
