...
begin
  Result:=0;
  if UpperCase(Mes) = 'ENERO' then Result := 1;
  if UpperCase(Mes) = 'FEBRERO' then Result := 2;
  if UpperCase(Mes) = 'MARZO' then Result := 3;
  if UpperCase(Mes) = 'ABRIL' then Result := 4;
  if UpperCase(Mes) = 'MAYO' then Result := 5;
  if UpperCase(Mes) = 'JUNIO' then Result := 6;
  if UpperCase(Mes) = 'JULIO' then Result := 7;
  if UpperCase(Mes) = 'AGOSTO' then Result := 8;
  if (UpperCase(Mes)='SEPTIEMBRE') or (UpperCase(Mes)='SETIEMBRE') then Result := 9;
  if UpperCase(Mes) = 'OCTUBRE' then Result := 10;
  if UpperCase(Mes) = 'NOVIEMBRE' then Result := 11;
  if UpperCase(Mes) = 'DICIEMBRE' then Result := 12;
end;
