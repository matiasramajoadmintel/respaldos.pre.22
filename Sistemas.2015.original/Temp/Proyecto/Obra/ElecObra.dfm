object frmElecObra: TfrmElecObra
  Left = 303
  Top = 135
  Width = 342
  Height = 399
    ...
    object grdDatos: TDBGrid
      ...
      Columns = <
        item
          ...
          Title.Caption = 'Nombre de la obra'
  ...
  object Query: TQuery
    DatabaseName = 'DBR'
    SQL.Strings = (
      'SELECT IdObra, TipoObra, Cliente, Nombre FROM vwObras'
      ''
      '')
    Left = 18
    Top = 176
    ...
    object QueryNombre: TStringField
      FieldName = 'Nombre'
      Origin = 'DBR.vwObras.Nombre'
      Size = 50
    end
    object QueryTipoObra: TStringField
      FieldName = 'TipoObra'
