object frmElecEmpleado: TfrmElecEmpleado
  Left = 224
  Top = 136
  Width = 418
  Height = 399
  ...
  object Query: TQuery
    DatabaseName = 'DBR'
    SQL.Strings = (
      'SELECT IdEmpleado, Apellido, Nombres FROM vwEmpleados'
      ''
      '')
    Left = 18
    Top = 176
    object QueryApellido: TStringField
      FieldName = 'Apellido'
      Origin = 'DBR.vwEmpleados.Apellido'
      Size = 50
    end
    object QueryNombres: TStringField
      FieldName = 'Nombres'
      Origin = 'DBR.vwEmpleados.Nombres'
      Size = 50
    end
    object QueryIdEmpleado: TSmallintField
