object frmPrincipal: TfrmPrincipal
  ...
  object MainMenu1: TMainMenu
    ...
    object Ingresos1: TMenuItem
      ...
      object Formulariodepago1: TMenuItem
        Caption = 'Formulario de pago'
        OnClick = Formulariodepago1Click
      end
    end
  ...
  object Q: TQuery
    DatabaseName = 'ADB'
    SQL.Strings = (
      'SELECT Persona.IDPERSONA, Persona.APELLIDO,'
      
        'Persona.TIPODOCUMENTO, Persona.NRODOCUMENTO AS DOCUMENTO, Descue' +
        'nto.MES, Descuento.ANIO,'
      
        'Descuento.MONTO,  Ocupante_particular.COSTOALQUILER * 0.1 ,  Ocu' +
        'pante_particular.COSTOALQUILER * 0.9,'
      
        'EDIFICIO.DESCRIPCION, DEPARTAMENTO.DESCRIPCION, EDIFICIO.DESCRIP' +
        'CION, DEPARTAMENTO.DESCRIPCION'
      ...
      '   ON  (Ocupacion.IDDEPARTAMENTO = Departamento.IDDEPARTAMENTO)'
        ...
        'WHERE  Persona.TIPO = '#39'OCUP_PART'#39' AND OCUPACION.FECHARETIRO IS N' +
        'ULL'
      '')
    Left = 264
    Top = 18
