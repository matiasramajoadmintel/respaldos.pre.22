object frmRemito: TfrmRemito
  ...
  object Panel2: TPanel
    ...
    object btnElegirPedido: TBitBtn
      Left = 296
      Top = 3
      Width = 75
      Height = 25
  ...
  object Panel4: TPanel
    ...
    object btnBuscarRecibe: TSpeedButton
      Left = 531
      Top = 59
      Width = 23
      Height = 22
  ...
  object Table: TTable
    ...
    object TableIdRecibe: TSmallintField
      FieldName = 'IdRecibe'
      Required = True
      Visible = False
    end
    ...
    object TableRecibe: TStringField
  ...
  object ITEM: TTable
    DatabaseName = 'DBR'
    TableName = 'dbo.ItemRemito'
    Left = 392
    Top = 171
    object ITEMIdRemito: TSmallintField
      FieldName = 'IdRemito'
      Required = True
    end
  ...
  object qryItemsPedido: TQuery
    DatabaseName = 'DBR'
    SQL.Strings = (
      'SELECT IdMaterial, Cantidad FROM ItemPedido'
      'WHERE IdPedido = :P')
    Left = 158
    Top = 171
    ParamData = <
    ...
    object qryItemsPedidoIdMaterial: TSmallintField
      FieldName = 'IdMaterial'
      Origin = 'DBR.ItemPedido.IdMaterial'
    end
    object qryItemsPedidoCantidad: TSmallintField
      FieldName = 'Cantidad'
  ...
  object PED: TTable
    ...
    Left = 450
    Top = 173
    object PEDIdPedido: TSmallintField
      FieldName = 'IdPedido'
      Required = True
    end
    object PEDIdRemito: TSmallintField
      FieldName = 'IdRemito'
    end
  end
  object qryPedidos: TQuery
    DatabaseName = 'DBR'
    SQL.Strings = (
      'SELECT Proveedor, Numero FROM vwPedidos'
      'WHERE IdRemito = :R')
    Left = 188
    Top = 173
    ParamData = <
