object frmElecOcupante: TfrmElecOcupante
  ...
  object Query1: TQuery
    ...
    DatabaseName = 'DB'
    SQL.Strings = (
      'SELECT * FROM VW_OCUPANTES_MILITARES'
      'UNION'
      'SELECT * FROM VW_OCUPANTES_CIVILES'
      'UNION'
      'SELECT * FROM VW_OCUPANTES_PARTICULARES')
    Left = 18
    Top = 176
    object Query1IDPERSONA: TIntegerField
      FieldName = 'IDPERSONA'
    end
    ...
    object Query1TipoPers: TStringField
      FieldKind = fkCalculated
      FieldName = 'TipoPers'
      Calculated = True
    end
    object Query1MR: TStringField
      FieldKind = fkCalculated
      FieldName = 'MR'
      Size = 12
      Calculated = True
