object dmDatos: TdmDatos
  ...
  object COEF: TTable
    ...
    object COEFPORCENTAJE2: TFloatField
  ...
  object qryGastosServXEdif: TQuery
    ...
    SQL.Strings = (
      ...
      'WHERE  SERV_EDIF.FECHA_PAGO >= :F1 AND '
      'SERV_EDIF.FECHA_PAGO <= :F2 AND SERV_EDIF.Vacios = '#39'No'#39' '
      'AND SERV_EDIF.A_PAGAR_OCUPANTE = '#39'No'#39
  ...
  object qryCantViviendas: TQuery
    ...
    SQL.Strings = (
      ...
      'FROM DEPARTAMENTO Departamento'
      'WHERE  Departamento.ACTIVO = '#39'SI'#39' ')
    Left = 246
    Top = 350
  ...
  object PERS: TTable
    ...
    object PERSIDGRADO: TIntegerField
      FieldName = 'IDGRADO'
      Required = True
    end
  end
  object qryCantDeptosXEdif: TQuery
    DatabaseName = 'ADB'
    SQL.Strings = (
      'SELECT COUNT( Departamento.IDDEPARTAMENTO ) TOTAL_VIVIENDAS'
      'FROM DEPARTAMENTO Departamento'
    ...
    object qryCantDeptosXEdifTOTAL_VIVIENDAS: TIntegerField
      FieldName = 'TOTAL_VIVIENDAS'
      Origin = 'ADB.DEPARTAMENTO.IDDEPARTAMENTO'
    end
  end
  object tblCostoDeptoVacio: TTable
    DatabaseName = 'ADB'
    TableName = 'COSTO_DEPTO_VACIO'
    Left = 36
    Top = 466
    object tblCostoDeptoVacioIDCOSTO_DEPTO_VACIO: TIntegerField
      FieldName = 'IDCOSTO_DEPTO_VACIO'
    end
    object tblCostoDeptoVacioMES: TStringField
      FieldName = 'MES'
      Size = 10
    end
    object tblCostoDeptoVacioANIO: TIntegerField
      FieldName = 'ANIO'
    end
    object tblCostoDeptoVacioMONTO_ADMIN: TFloatField
      FieldName = 'MONTO_ADMIN'
    end
    object tblCostoDeptoVacioMONTO_EXP: TFloatField
      FieldName = 'MONTO_EXP'
    end
    object tblCostoDeptoVacioIDLOCACION: TIntegerField
      FieldName = 'IDLOCACION'
      Required = True
    end
    object tblCostoDeptoVacioIDTIPO_LOCACION: TIntegerField
      FieldName = 'IDTIPO_LOCACION'
      Required = True
    end
    object tblCostoDeptoVacioMONTO_EXP_EDIF: TFloatField
      FieldName = 'MONTO_EXP_EDIF'
      Required = True
    end
  end
  object qryDeptosVacios: TQuery
    DatabaseName = 'ADB'
    SQL.Strings = (
      
        'SELECT Departamento.IDEDIFICIO, Departamento.IDDEPARTAMENTO, Dep' +
        'artamento.COEFICIENTE'
      'FROM DEPARTAMENTO'
      
        'WHERE IDDEPARTAMENTO NOT IN (SELECT IDDEPARTAMENTO FROM OCUPACIO' +
        'N'
      
        'WHERE Ocupacion.FECHARETIRO IS NULL) AND Departamento.IDEDIFICIO' +
        ' = :E')
    Left = 236
    Top = 464
    ParamData = <
    ...
    object qryDeptosVaciosIDEDIFICIO: TIntegerField
      FieldName = 'IDEDIFICIO'
    end
    object qryDeptosVaciosIDDEPARTAMENTO: TIntegerField
      FieldName = 'IDDEPARTAMENTO'
    end
    object qryDeptosVaciosCOEFICIENTE: TFloatField
      FieldName = 'COEFICIENTE'
    end
  end
  ...
  object qryOcupParticulares: TQuery
    DatabaseName = 'ADB'
    SQL.Strings = (
      'SELECT * FROM VW_OCUP_PART_ACTUALES')
    Left = 488
    Top = 240
    object qryOcupParticularesIDOCUPANTE: TIntegerField
      FieldName = 'IDOCUPANTE'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.IDOCUPANTE'
    end
    object qryOcupParticularesOCUPANTE: TStringField
      FieldName = 'OCUPANTE'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.OCUPANTE'
      Size = 41
    end
    object qryOcupParticularesLOCACION: TStringField
      FieldName = 'LOCACION'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.LOCACION'
      Size = 111
    end
    object qryOcupParticularesFECHAINI: TDateTimeField
      FieldName = 'FECHAINI'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.FECHAINI'
    end
    object qryOcupParticularesFECHAFIN: TDateTimeField
      FieldName = 'FECHAFIN'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.FECHAFIN'
    end
    object qryOcupParticularesIDEDIFICIO: TIntegerField
      FieldName = 'IDEDIFICIO'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.IDEDIFICIO'
    end
    object qryOcupParticularesIDDEPARTAMENTO: TIntegerField
      FieldName = 'IDDEPARTAMENTO'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.IDDEPARTAMENTO'
    end
    object qryOcupParticularesLEGAJO: TIntegerField
      FieldName = 'LEGAJO'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.LEGAJO'
    end
    object qryOcupParticularesSUELDO: TFloatField
      FieldName = 'SUELDO'
      Origin = 'DBADMIN.VW_OCUP_PART_ACTUALES.SUELDO'
    end
  end
  object tblOcupanteParticular_: TTable
    DatabaseName = 'ADB'
    TableName = 'OCUPANTE_PARTICULAR'
    Left = 480
    Top = 304
    object tblOcupanteParticular_IDPERSONA: TIntegerField
      FieldName = 'IDPERSONA'
      Required = True
    end
    object tblOcupanteParticular_IDGARANTE: TIntegerField
      FieldName = 'IDGARANTE'
      Required = True
    end
    object tblOcupanteParticular_PARENTEZCO: TStringField
      FieldName = 'PARENTEZCO'
      Size = 15
    end
    object tblOcupanteParticular_COSTOALQUILER: TFloatField
