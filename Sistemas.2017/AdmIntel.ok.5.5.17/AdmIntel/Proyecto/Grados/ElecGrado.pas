...
//    hoy:= DateToStr(today);
    ...
    i:=i+1;
    Libro.Cells [i+6,1] := qryGrados.FieldByName ('IDGRADO').AsString;
    Libro.Cells [i+6,2] := qryGrados.FieldByName ('DESCRIPCION').AsString;
    Libro.Cells [i+6,3] := qryGrados.FieldByName ('ABREVIATURA').AsString;
    Libro.Cells [i+6,4] := qryGrados.FieldByName ('TIEMPO_MINIMO').AsString;
    Libro.Cells [i+6,5] := qryGrados.FieldByName ('COD201').AsInteger;
    Libro.Cells [i+6,6] := qryGrados.FieldByName ('COD209').AsInteger;
