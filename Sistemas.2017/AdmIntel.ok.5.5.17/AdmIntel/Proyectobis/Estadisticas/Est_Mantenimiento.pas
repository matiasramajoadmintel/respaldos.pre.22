...
procedure TfrmEstMantenimiento.Mostrar(FechaInicio, FechaFin: TDateTime);
begin
...
procedure TfrmEstMantenimiento.PrepararFormulario(FechaInicio, FechaFin: TDateTime);
begin
...
procedure TfrmEstMantenimiento.FiltrarQuery(FechaInicio, FechaFin: TDateTime);
var
  Filtro: String;
begin
  Filtro := '';
...
procedure TfrmEstMantenimiento.BitBtn2Click(Sender: TObject);
var
  form: TForm;
begin
