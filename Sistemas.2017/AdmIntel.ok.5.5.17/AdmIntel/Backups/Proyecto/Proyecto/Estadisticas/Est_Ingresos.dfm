object frmEstIngresos: TfrmEstIngresos
  ...
  object DecisionQuery1: TDecisionQuery
    ...
    SQL.Strings = (
        ...
        'SELECT FECHA, CONCEPTO, TIPO_PAGO, SUM( IMPORTE_MANT ), SUM( IMP' +
        'ORTE_SERV )'
      'FROM VW_INGRESOS'
  ...
  object DecisionCube1: TDecisionCube
    ...
    DimensionMap = <
      ...
      item
        ...
        FieldType = ftFloat
        Fieldname = 'SUM'
        BaseName = 'VW_INGRESOS.IMPORTE_MANT'
        Name = 'SUM'
        DerivedFrom = -1
      ...
      item
        ...
        FieldType = ftFloat
        Fieldname = 'SUM_1'
        BaseName = 'VW_INGRESOS.IMPORTE_SERV'
        Name = 'SUM_1'
        DerivedFrom = -1
        DimensionType = dimSum
        BinType = binNone
