object dmQuerys: TdmQuerys
  ...
  object qryOcupActuales: TQuery
    ...
    object qryOcupActualesGARANTE: TStringField
      DisplayLabel = 'Garante'
      FieldName = 'GARANTE'
      Origin = 'ADB.VW_OCUPANTES_ACTUALES.IDOCUPANTE'
      Size = 41
    end
    object qryOcupActualesPARENTEZCO: TStringField
      DisplayLabel = 'Parentezco'
  ...
  object qryDeudores: TQuery
    ...
    SQL.Strings = (
        ...
        'CULA, Serv_edif.fecha_pago, Servicio.DESCRIP'
    ...
    Left = 16
    Top = 266
    object qryDeudoresCOSTO: TFloatField
      DisplayLabel = 'Importe'
      FieldName = 'COSTO'
      Origin = 'ADB.SERV_EDIF.COSTO'
      currency = True
    end
    object qryDeudoresNRO_FACT: TIntegerField
      DisplayLabel = 'N'#186' Factura'
      FieldName = 'NRO_FACT'
      Origin = 'ADB.SERV_EDIF.NRO_FACT'
    end
    object qryDeudoresIDPERSONA: TIntegerField
      FieldName = 'IDPERSONA'
      Origin = 'ADB.SERV_EDIF.IDPERSONA'
      Visible = False
    end
    object qryDeudoresOCUPANTE: TStringField
      DisplayLabel = 'Ocupante'
      FieldName = 'OCUPANTE'
      Origin = 'ADB.VW_PERSONAS_2.OCUPANTE'
      Size = 41
    end
    object qryDeudoresTIPO: TStringField
      DisplayLabel = 'Tipo'
      FieldName = 'TIPO'
      Origin = 'ADB.VW_PERSONAS_2.TIPO'
    end
    object qryDeudoresMATRICULA: TStringField
      DisplayLabel = 'Matr'#237'cula'
      FieldName = 'MATRICULA'
      Origin = 'ADB.VW_PERSONAS_2.MATRICULA'
      Size = 10
    end
    object qryDeudoresFECHA_PAGO: TDateTimeField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHA_PAGO'
    end
    object qryDeudoresDESCRIP: TStringField
