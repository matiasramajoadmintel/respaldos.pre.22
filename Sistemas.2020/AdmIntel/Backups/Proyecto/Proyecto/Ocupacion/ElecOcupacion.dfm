object frmElecOcupacion: TfrmElecOcupacion
  ...
  object Query1: TQuery
    ...
    object Query1NOMBRE: TStringField
      FieldName = 'NOMBRE'
      Origin = 'DB.VW_OCUPACION.NOMBRE'
      Visible = False
      Size = 25
    end
    object Query1APELLIDO: TStringField
      FieldName = 'APELLIDO'
      Origin = 'DB.VW_OCUPACION.APELLIDO'
      Visible = False
      Size = 15
    end
    object Query1DESCRIPCIONED: TStringField
      ...
      Origin = 'DB.VW_OCUPACION.DESCRIPCIONED'
      Size = 50
    end
    object Query1DESCRIPCIONDEPT: TStringField
      DisplayLabel = 'Depto.'
      FieldName = 'DESCRIPCIONDEPT'
      Origin = 'DB.VW_OCUPACION.DESCRIPCIONDEPT'
      Size = 10
    end
