object frmOcupanteCivil: TfrmOcupanteCivil
  ...
  object OC_: TTable
    ...
    object OC_DESTINO: TStringField
      FieldName = 'DESTINO'
      Size = 30
    end
  end
  ...
  object ztblOC_: TZTable
    ...
    Left = 336
    Top = 109
    object ztblOC_idpersona: TIntegerField
      FieldName = 'idpersona'
      Required = True
    end
    object ztblOC_categoria: TStringField
      FieldName = 'categoria'
      Size = 30
    end
    object ztblOC_legajo: TStringField
      FieldName = 'legajo'
      Size = 30
    end
    object ztblOC_sueldo: TFloatField
      FieldName = 'sueldo'
    end
    object ztblOC_destino: TStringField
      FieldName = 'destino'
      Size = 90
    end
  end
