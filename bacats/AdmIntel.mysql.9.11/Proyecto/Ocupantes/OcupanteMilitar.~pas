...
type
  TfrmOcupanteMilitar = class(TForm)
    ...
    strngfldOM_telefono_destino: TStringField;
    strngfldOM_Grado: TStringField;
    strngfldOM_Especialidad: TStringField;
    strngfldOM_matricula: TStringField;
...
begin
  ...
  begin
    ...
    begin
      ...
      strngfldOM_MATRICULA.Text := strngfldMNO_MATRICULA.Text;
    end;
  end;
