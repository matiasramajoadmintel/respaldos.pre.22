object frmOcupanteMilitar: TfrmOcupanteMilitar
  ...
  object ztblES_: TZTable
    ...
    object ztblES_descripcion: TStringField
      FieldName = 'descripcion'
      Required = True
      Size = 150
    end
  ...
  object ztblOM_: TZTable
    ...
    object ztblOM_destino: TStringField
      FieldName = 'destino'
      Size = 90
    end
    ...
    object ztblOM_telefono_destino: TStringField
      FieldName = 'telefono_destino'
      Size = 18
    end
    ...
    object ztblOM_ESPECIALIDAD: TStringField
      FieldKind = fkLookup
      FieldName = 'ESPECIALIDAD'
      LookupDataSet = ztblES_
      LookupKeyFields = 'idespecialidad'
      LookupResultField = 'descripcion'
      KeyFields = 'idespecialidad'
      Size = 30
