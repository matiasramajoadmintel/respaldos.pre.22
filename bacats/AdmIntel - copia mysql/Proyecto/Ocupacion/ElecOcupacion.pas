...
uses
  ...
  Dialogs, Buttons, Grids, DBGrids, StdCtrls, ExtCtrls, DB, DBTables, Principal,
...
type
  TfrmElecOcupacion = class(TForm)
    ...
    Button1: TButton;
    ZQuery1: TZQuery;
    ZQuery1FECHAINI: TDateTimeField;
    ZQuery1FECHAFIN: TDateTimeField;
    ZQuery1FECHARETIRO: TDateTimeField;
    ZQuery1OCUPANTE: TStringField;
    ZQuery1LOCACION: TStringField;
...
begin
        ...
        begin
                ...
                Existe(ZQuery1,'IdOcupacion',IdOcupacion);
        end;
end;
...
begin
        with TfrmIngOcupacion.Create(nil) do
        begin
               // R:=Eliminar(ZQuery1IdOcupacion.Value);
                Release;
        end;
        if R then
                PrepararQuery (gOrden, gVer);
...
var
        ...
        IdOcupacion:integer;
begin
        // IdOcupacion:=ZQuery1IdOcupacion.Value;
        with TfrmIngOcupacion.Create(nil) do
        begin
                if gModo <> 3 then
