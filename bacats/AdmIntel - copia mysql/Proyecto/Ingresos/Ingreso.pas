...
type
  ...
  private
    ...
    gOrden: String;
    Procedure PrepararQuery(const Modo: Byte; Orden: String);
...
Procedure TfrmIngreso.PrepararQuery(const Modo: Byte; Orden: String);
var
...
begin
     ...
     if edtDesc.Text <> ''  then
       Filtro := 'WHERE (' +
                 //'Concepto LIKE ' + #39 + '%' + edtDesc.Text + #39 + ') OR (' +
                 'CONCEPTO LIKE ' + #39 + '%' + UpperCase(edtDesc.Text) + '%' + #39 + ') OR (' +
                 //'Concepto LIKE ' + #39 + edtDesc.Text + '%' + #39 + ') OR (' +
                 //'Concepto LIKE ' + #39 + edtDesc.Text + #39 + ') OR (' +
                 //'Sr LIKE ' + #39 + '%' + edtDesc.Text + #39 + ') OR (' +
                 'SR LIKE ' + #39 + '%' + UpperCase(edtDesc.Text) + '%' + #39 + ')'; // OR (' +
                 //'Sr LIKE ' + #39 + edtDesc.Text + '%' + #39 + ') OR (' +
                 //'Sr LIKE ' + #39 + edtDesc.Text + #39 + ')';
...
procedure TfrmIngreso.grdDatosTitleClick(Column: TColumn);
begin
  PrepararQuery(gModo, Column.FieldName);
