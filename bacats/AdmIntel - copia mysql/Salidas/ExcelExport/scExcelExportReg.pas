...
* When you like to add the component to an existing package, add the unit
  ...
  This file can be found in the Borland\Delphi\Lib, Codegear\RAD Studio\x.0\Lib 
  or Embarcadero\RAD Studio\x.0\Lib folder.
...
begin
  ...
  case Index of
    0 :
      begin
        MessageDlg('TscExcelExport 4.28'+#13+#10+'Stefan Cruysberghs'+#13+#10+
          'Open-source, July 2016'+#13+#10+
